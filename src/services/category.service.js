 ...
 */
const getAllCategoriesService = async (params, req) => {
  const { 
    page = 1, 
    limit = 50,
    search,
 ...
 */
const getCategoryByIdService = async (id, params, req) => {
 ...
 */
const getProductsByCategoryService = async (id, params, req) => {
 ...
 */
const createCategoryService = async (categoryData, req) => {
 ...
 */
const updateCategoryService = async (id, updateData, req) => {
